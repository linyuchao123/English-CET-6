...
export const metadata: Metadata = {
  ...
  title: '六级词伴｜每天 60 个 CET-6 高频词',
  description: '每天早上 8 点提醒，优先掌握 60 个英语六级高频词汇，完成后还可继续学习。',
  manifest: '/manifest.webmanifest',
  appleWebApp: { capable: true, title: '六级词伴', statusBarStyle: 'default' },
  icons: { icon: '/icon-192.png', apple: '/icon-192.png' },
  openGraph: {
    title: '六级词伴', description: '每天 60 个高频词，稳稳过六级', type: 'website', images: ['/og.png'],
  },
  twitter: { card: 'summary_large_image', title: '六级词伴', description: '每天 60 个高频词，稳稳过六级', images: ['/og.png'] },
};
